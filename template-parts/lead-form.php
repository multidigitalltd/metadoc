				...
				<div class="relative">
					...
					<form class="md-lead-form space-y-4" novalidate>
						<div class="grid sm:grid-cols-2 gap-4">
							<div>
								<label class="<?php echo esc_attr( $label ); ?>" for="lead-name"><?php metadoc_the_text( 'form_label_name' ); ?></label>
								<input id="lead-name" name="name" type="text" required class="<?php echo esc_attr( $input ); ?>" placeholder="<?php echo esc_attr( metadoc_text( 'form_ph_name' ) ); ?>" autocomplete="name">
							</div>
							<div>
								<label class="<?php echo esc_attr( $label ); ?>" for="lead-phone"><?php metadoc_the_text( 'form_label_phone' ); ?></label>
						...
						<div>
							<label class="<?php echo esc_attr( $label ); ?>" for="lead-note"><?php metadoc_the_text( 'form_label_note' ); ?></label>
							<textarea id="lead-note" name="note" rows="3" class="<?php echo esc_attr( $input . ' resize-none' ); ?>" placeholder="<?php echo esc_attr( metadoc_text( 'form_ph_note' ) ); ?>"></textarea>
						</div>
						...
						<p class="text-[11px] text-center text-white/50 flex items-center justify-center gap-1.5">
							...
							<?php metadoc_the_text( 'form_hint' ); ?>
						</p>
					</form>
				</div>
			</div>
